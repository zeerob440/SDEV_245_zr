...
In this project, students will create a small application or script that:
    ...
    X Write a short explanation describing how their solution upholds confidentiality, integrity, and availability
    X Explain the role of entropy and key generation in their implementation.
'''
